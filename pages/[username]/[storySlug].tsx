import { Avatar, Box, Container, Group, LoadingOverlay, Text, Title, TypographyStylesProvider, UnstyledButton } from '@mantine/core'
  ...
  return (
    <Container size="sm">
      ...
      <Link href={`/@${story?.userData.username}`} passHref>
        <UnstyledButton component="a" sx={(theme) => ({
          ...
          <Group>
            <Avatar src={story?.userData.avatar} alt={story?.userData.name} radius="xl" />
            <Box sx={{ flex: 1 }} >
